...
export const knownRouteTransform = ["request_body"];
export const knownRequestBodyReplacement = ["replace", "with", "regex"];
export const knownRouteInspect = ["enabled", "max_bytes", "grpc", "capture_sse"];
export const knownRouteInspectGrpc = ["decoder"];
export const knownRouteLog = ["grpc"];
export const knownRouteLogGrpc = ["ok"];
export const knownRouteLogGrpcOk = ["status", "methods", "log", "inspect"];
...
export const knownEnvStructured = ["required", "defaults", "terraform", "helm"];
export const knownTerraformEnv = ["path", "resource", "attribute"];
export const knownHelmEnv = ["path", "resource"];
...
export const knownSecrets = ["redact", "extra_markers", "extra_patterns"];
...
export const knownProjectEnvironment = ["sources", "secrets", "sops"];
export const knownSops = ["file", "input_type", "key_map"];
