...
type Core = "tokens" | "procs" | "clock" | "fs" | "bus" | "detectGoogle" | "healthCheckers" | "orchestrator" | "logs" | "detector" | "sessionID" | "inspectProcess" | "processAlive" | "acquireLock" | "socketExists" | "unlinkSocket" | "createMcpListener" | "isKnownTool" | "createCommands";
